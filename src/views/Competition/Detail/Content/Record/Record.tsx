...
import { CompetitionType, HackState, IHack, IRecord, User } from '@/type'
import React, { useEffect, useState } from 'react'
import { useOutletContext, useParams } from 'react-router-dom'
import { IRecordTableDataSource } from '@/type'
import { Table, Modal, Switch, Input, notification } from 'antd'
import Column from 'antd/es/table/Column'
import LanaugeLabel from '@/views/ProblemDetail/RecordLabel.tsx/LanaugeLabel'
...
const Record: React.FC = () => {
  ...
  const fetch = async () => {
    const { data } = await getRecordListApi(type, competition_id as string, {})
