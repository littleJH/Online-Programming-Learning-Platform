...
const itemClass =
  'h-60 w-96 m-4 p-12 bg-slate-50  rounded-xl shadow flex  hover:cursor-pointer hover:shadow-lg transition-all select-none'
...
const NavCard: React.FC<{
  ...
  return (
    <Space direction="vertical">
      ...
      <div
        className="text-base text-slate-500 h-12"
        style={{
          overflow: 'hidden',
