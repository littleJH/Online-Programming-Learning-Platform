...
const itemClass = 'h-48 w-80 m-8 p-4 bg-slate-50  rounded-xl shadow flex  hover:cursor-pointer hover:shadow-lg hover:-translate-y-4 transition-all duration-300 select-none'
