    ...
    <div>
      <div className={lineClass}>
        ...
        <Card
          ...
          <NavCard
            title='表单'
            content='点此创建表单'
            svgHref='#icon-liebiaoqingdan'></NavCard>
        </Card>
      </div>
      <div className={lineClass}>
        <Card
      ...
      <div className={lineClass}>
        <Card
          id='competition'
          className={itemClass}
          onClick={() => handleClick('competition/declare')}
          hoverable>
          <NavCard
            title='比赛'
            content='点此创建比赛'
            svgHref='#icon-competition'></NavCard>
        </Card>
      </div>
    </div>
  )
