    ...
    <div className="flex justify-center">
      {countDown?.day !== '00' && (
        <div className="countdown-section">
          ...
          <span className="countdown-period mx-4">天</span>
        </div>
      )}
      <div className="countdown-section">
        <span
          ...
          style={{
            backgroundColor: countDown?.hour === '00' ? token.colorInfoBorder : token.colorInfo,
          }}
        >
          {countDown?.hour}
        </span>
      ...
      <div className="countdown-section">
        <span
          className="countdown-amount"
          style={{
            backgroundColor: countDown?.min === '00' ? token.colorInfoBorder : token.colorInfo,
          }}
        >
          {countDown?.min}
        </span>
      ...
      <div className="countdown-section">
        <span
          className="countdown-amount"
          style={{
            backgroundColor: countDown?.second === '00' ? token.colorInfoBorder : token.colorInfo,
          }}
        >
          {countDown?.second}
        </span>
